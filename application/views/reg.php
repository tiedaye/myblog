...
<div id="OSC_Screen">
    <div id="OSC_Content" class="CenterDiv"><style>
        ...
        <div class="MainForm" id="reg_page">
            <form id="frm_reg" action="" method="POST" onsubmit="return false" style="float:left; width:620px;">
...
<script>
    ...
    $("#f_vcode").on("focus",function () {
        $("#code_msg").html("")
    })
    $("#change_img").on("click",function () {
        $.get("welcome/change_img",{
